...
class COCOeval:
    ...
    def SAfit(self, bb_test, bb_gt, C):
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            stats[4] = _summarize(1, areaRng='extreme small', maxDets=self.params.maxDets[2])
            ...
            stats[11] = _summarize(0, areaRng='tiny', maxDets=self.params.maxDets[2])
            stats[12] = _summarize(0, areaRng='extreme small', maxDets=self.params.maxDets[2])
...
class Params:
    ...
    def setDetParams(self):
        ...
        self.areaRngLbl = ['all', 'tiny', 'extreme small', 'small', 'medium', 'large']
        self.useCats = 1
